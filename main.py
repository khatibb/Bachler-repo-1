...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_dir', type=str, default='./content/gdrive2/My Drive/metatransferlearning/data/mini/mini-imagenet/') # Dataset folder
    #./data/mini/mini-imagenet/
    #/content/gdrive2/My Drive/metatransferlearning/data/mini/mini-imagenet
